...
<body>
    ...
    <header class="header">
        ...
        <div class="header-2">
            <nav class="navbar d-flex justify-content-center">
                ...
                <a href="php/viewbooks.php">Books</a>
                <a href="#review">Top reviewed</a>
                <a href="php/search.php">Search</a>
                <a href="php/request.php">Request</a>
            </nav>
        </div>
    </header>
    ...
    <section class="home" id="home">
        ...
        <div class="row">
            ...
            <div class="content">
                <h3>Wanna be part of our community?</h3>
                <p>Give your precious opnion about your favourite books by joining our commnunity, So what are you
                    waiting for? Click below!! </p>
                <a href="php/register.php" class="btn">Register</a>
    ...
    <section class="newsletter" id="newsletter">
        ...
        <form action="">
            ...
            <div class="genres">
                ...
                <a href="php/genre.php?genre=art">Art</a><br><br>
                <a href="php/genre.php?genre=fantasy" class="">Fantasy</a><br><br>
                <a href="php/genre.php?genre=horror" class="">Horror</a><br><br>
                <a href="php/genre.php?genre=literature" class="">Literature</a><br><br>
                <a href="php/genre.php?genre=romance" class="">Romance</a><br><br>
                <a href="php/genre.php?genre=science fiction" class="">Science Fiction</a><br><br>
                <a href="php/genre.php?genre=thriller" class="">Thriller</a><br><br>
                <a href="php/genre.php?genre=history" class="">History</a><br><br>
                <a href="php/genre.php?genre=poetry" class="">Poetry</a><br><br>
                <a href="php/genre.php?genre=classic" class="">Classic</a><br><br>
